...
def most_recent_passport_details(driver, user_data):
    try:    
        ...
        is_book_correct_details_needed = is_correct_details_needed(date_of_birth_str, book_issue_date_str) if book_issue_date_str else False
        is_card_correct_details_needed = is_correct_details_needed(date_of_birth_str, card_issue_date_str) if card_issue_date_str else False
